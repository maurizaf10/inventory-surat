...
<body>
    ...
    <div class="content" align="center">
      ...
      $queri4 = mysqli_query($koneksi,"SELECT * FROM pengajuan_peminjaman");
      $queri5 = mysqli_query($koneksi,"SELECT * FROM peminjaman");     
      

      $jml_karyawan = mysqli_num_rows($queri1);
      $jml_admin = mysqli_num_rows($queri2);
      $jml_surat = mysqli_num_rows($queri3);
      $jml_pengajuan_peminjaman = mysqli_num_rows($queri4);
      $jml_peminjaman = mysqli_num_rows($queri5);
