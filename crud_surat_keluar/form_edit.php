...
<body>
    ...
    <h3 align="center">Edit Data Surat Keluar</h3>
    <form action="proses_edit.php" method="post">
      <?php 
      include "../koneksi.php";
      $id = $_GET['id'];

      $query = mysqli_query($koneksi, "SELECT * FROM surat_keluar WHERE id = '$id'") or die(mysqli_error($koneksi));
      ...
      <table align="center">
        ...
        <tr>
          ...
          <td>
            <input type="date" size="60" name="tanggal_keluar" value="<?php echo $data['tanggal_keluar'] ?>" required>
          </td> 
        </tr> 
        <tr>
          <td>Tujuan</td>
          <td>
            <input type="text" size="60" name="tujuan" value="<?php echo $data['tujuan'] ?>" required>
          </td> 
        </tr> 
          <td></td>
