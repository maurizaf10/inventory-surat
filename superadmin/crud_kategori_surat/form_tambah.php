...
<body>
    ...
    <h3 align="center">Input Data Kategori Surat</h3>
      <form action="proses_tambah.php" method="post">   
        <table align="center">
          <tr>
            <td>Nama Kategori</td>
            <td><input type="text" name="nama_kategori" size="80" required></td>         
          </tr> 
          <tr>
            <td>Keterangan Surat</td>
            <td><input type="text" name="keterangan" size="80" required></td>          
          </tr>
          <tr>
            <td>Status</td>
            <td><input type="text" name="status" size="80" required></td>          
          </tr>
          <tr>            
            <td>
            ...
            <td></td>
            <td><button type="submit" class="simpan" value="Upload" name="upload">Simpan</button></td>          
          </tr>       
        </table>
      </form>    
