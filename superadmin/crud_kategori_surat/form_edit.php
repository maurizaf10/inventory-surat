...
<body>
    ...
    <div class="sidebar">
      ...
      <a href="index.php"><i class="fas fa-table"></i><span>Kategori Surat</span></a>     
    ...
    <h3 align="center">Edit Data Kategori Surat</h3>
    <form action="proses_edit.php" method="post">
      <?php 
      include "../../koneksi.php";
      $id = $_GET['id'];

      $query = mysqli_query($koneksi, "SELECT * FROM kategori_surat WHERE id = '$id'") or die(mysqli_error($koneksi));
      ...
      <table align="center">
        <tr>
          ...
          <td>
            ...
            <input type="text" size="80" name="nama_kategori" value="<?php echo $data['nama_kategori'] ?>" required>
          </td>     
        </tr> 
        <tr>
          <td>Keterangan</td>
          <td>
            <input type="text" size="80" name="keterangan" value="<?php echo $data['keterangan'] ?>" required>
          </td> 
        </tr>
        <tr>
          <td>Status</td>
          <td>
            <input type="text" size="80" name="status" value="<?php echo $data['status'] ?>" required>
          </td> 
        </tr>
          <td></td>
