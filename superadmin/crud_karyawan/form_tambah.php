...
<body>
    ...
    <div class="sidebar">
      ...
      <a href="../crud_kategori_surat/index.php"><i class="fas fa-table"></i><span>Kategori Surat</span></a>   <a href="../perusahaan/index.php"><i class="fas fa-table"></i><span>Perusahaan</span></a>
    ...
    <h3 align="center">Input Data Karyawan</h3>
      <form action="proses_tambah.php" method="post">   
        <table align="center">
          <tr>
            <td>Nama Karyawan</td>
            <td><input type="text" name="nama_karyawan" size="60" required></td>         
          </tr> 
          <tr>
            <td>Perusahaan</td>
            <td><input type="text" name="perusahaan" size="60" required></td>          
          </tr>
          <tr>
            <td>Username</td>
