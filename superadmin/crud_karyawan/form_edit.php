...
<body>
    ...
    <div class="sidebar">
      ...
      <a href="index.php"><i class="fas fa-table"></i><span>Karyawan</span></a>
      ...
      <table align="center">
        <tr>
          ...
          <td>
            ...
            <input type="text" size="60" name="nama_karyawan" value="<?php echo $data['nama_karyawan'] ?>" required>
          </td>     
        </tr> 
        <tr>
          <td>Perusahaan</td>
          <td>
            <input type="text" size="60" name="perusahaan" value="<?php echo $data['perusahaan'] ?>" required>
          </td> 
        </tr>
        <tr>
          <td>Username</td>
          <td>
            <input type="text" size="60" name="username" value="<?php echo $data['username'] ?>" required>
          </td> 
        </tr> 
        <tr>
          <td>Email</td>
          <td>
            <input type="text" size="60" name="email" value="<?php echo $data['email'] ?>" required>
          </td> 
        </tr>   
          <td></td>
