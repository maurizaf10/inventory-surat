...
<body>
    ...
    <div class="content">
      ...
      <h3 align="center">Daftar Perusahaan</h3>
        ...
        <?php 
          ...
          while($data = mysqli_fetch_array($query)) { ?>
            <tr class="table-td">
              ...
              <a href="list_surat.php"><button class="edit">List Surat</button></a>
              <a href="list_user.php"><button class="edit">List User</button></a> 
              <a href="list_admin.php"><button class="edit">List Admin</button></a> 
