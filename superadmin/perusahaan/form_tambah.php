...
<body>
    ...
    <div class="content" >
      ...
      <h3 align="center">Input Data Perusahaan</h3>
      <form action="proses_tambah.php" method="post">   
        <table align="center">           
          <tr>
            <td>Nama Perusahaan</td>
            <td><input type="text" name="nama_perusahaan" size="50" required></td>          
          </tr>
          <tr>
            <td>Alamat Perusahaan</td>
            <td><input type="text" name="alamat_perusahaan" size="50" required></td>          
          </tr>
          <tr>
            <td>Nomer Telepon</td>
