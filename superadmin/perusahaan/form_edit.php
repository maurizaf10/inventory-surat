...
<body>
    ...
    <div class="content">
		...
		<h3 align="center">Edit Data Perusahaan</h3>
		<form action="proses_edit.php" method="post">
			<?php 
			include "../../koneksi.php";
			$id = $_GET['id'];

			$query = mysqli_query($koneksi, "SELECT * FROM perusahaan WHERE id = '$id'") or die(mysqli_error($koneksi));
            ...
            <input type="text" size="50" name="nama_perusahaan" value="<?php echo $data['nama_perusahaan'] ?>" required>
          </td>	
				</tr>
        <tr>
          <td>Alamat Perusahaan</td>
          <td>
            <input type="text" size="50" name="alamat_perusahaan" value="<?php echo $data['alamat_perusahaan'] ?>" required>
          </td> 
        </tr>
        <tr>
					<td>Nomer Telepon</td>
					<td><input type="text" size="50" name="no_telp" value="<?php echo $data['no_telp'] ?>" required></td>		
				</tr>	
        <tr>
