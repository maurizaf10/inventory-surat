...
<body>
    ...
    <div class="sidebar">
      ...
      <a href="index.php"><i class="fas fa-table"></i><span>Daftar Peminjaman</span></a>
    ...
    <div class="content">
      ...
      <div style="overflow: auto;">
        ...
        <?php 
          include "../koneksi.php";
          $query = mysqli_query($koneksi, "SELECT * FROM peminjaman") or die(mysqli_error($koneksi));
          $nomor = 1;
          while($data = mysqli_fetch_array($query)) { ?>
            <tr class="table-td">
              ...
              <td><?php echo $data['tanggal_konfirmasi']; ?></td>
