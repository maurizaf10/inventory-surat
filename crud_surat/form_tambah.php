...
<body>
    ...
    <div class="content" >
      ...
      <h3 align="center">Input Data Surat</h3>
      <form action="proses_tambah.php" method="post">   
        <table align="center">
           
          <tr>
            <td>No Surat</td>
            <td><input type="text" name="no_surat" size="50" required></td>          
          </tr>
          <tr>
            <td>Nama Surat</td>
            <td><input type="text" name="nama_surat" size="50" required></td>          
          </tr>
          <tr>
            <td>Kategori Surat</td>
            <td><input type="text" name="kategori_surat" size="50" required></td>          
          </tr>
          <tr>
            <td>Ketersediaan</td>
            <td><input type="text" name="ketersediaan" size="50" required></td>         
          </tr> 
          <tr>
            <td>Status Fisik</td>
            <td><input type="text" name="status_fisik" size="50" required></td>         
          </tr>
          <tr>
            <td>Perusahaan</td>
            <td><input type="text" name="perusahaan" size="50" required></td>         
          </tr>
            <td></td>
